...
class TestStockInfoResolver(unittest.TestCase):
    ...
    def test_get_index_code(self):
        ...
        self.assertEqual(StockInfoResolver.get_index_code(hk_share), "^HSI")
...
class TestStrategies(unittest.TestCase):
    ...
    def test_buy_and_hold(self):
        ...
        self.assertIsNotNone(
            result.total_return
        )  # Should have a return (can be negative)
    ...
    def test_compare_strategies(self):
        ...
        strategies = [BuyAndHoldStrategy(), HighSellLowBuyStrategy()]
