        ...
        if sector in sector_etfs:
            try:
                ...
                if not sector_data.empty:
                    ...
                    def get_col(col):
                        """Extract column data from DataFrame or Series."""
                    ...
                    df_sector["sector_ma20"] = (
                        df_sector["sector_close"].rolling(window=20).mean()
                    )
                    df_sector["sector_ma_ratio"] = (
                        df_sector["sector_close"] / df_sector["sector_ma20"]
                    )
